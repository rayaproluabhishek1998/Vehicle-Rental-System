...
<nav class="navbar navbar-default navbar-fixed-top">
		<div class="navbar-collapse">
			<ul class="nav navbar-nav">
				<li><a href="/wallet">Add To Wallet</a></li>
				<li><a href="/selectVehicle">Select Vehicles</a></li>
				<li><a href="/usermyBookings">My Bookings</a></li>
				<li><a href="/givefeedback">Give Feedback</a>
			</ul>
