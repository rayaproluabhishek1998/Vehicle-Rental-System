	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="navbar-collapse">
			<ul class="nav navbar-nav">
				<li><a href="/viewVendors">View Vendors</a></li>
				<li><a href="/viewVehileType">View Vehicles</a></li>
				<li><a href="/allbookings">View Bookings</a></li>
				<li><a href="/viewfeedback">View Feedback</a>
			</ul>
