...
<body>
	...
	<center>
		<h1 align="center">WELCOME TO VENDOR LOGIN PAGE</h1>
		<div>
			<img alt="" src="/images/vendor-icon.jpg" height="200" width="200" title="Vendor Login"/>
		</div>
		<h2>${message}</h2>
		<div class="main">
			<form action="/vendorhomepage" method="post">
